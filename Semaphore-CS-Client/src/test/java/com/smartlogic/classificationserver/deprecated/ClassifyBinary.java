...
public class ClassifyBinary extends ClassificationTestCase {
	protected final static Log logger = LogFactory.getLog(ClassifyBinary.class);
	...
	public void testBinary() throws IOException, ClassificationException {
		...
		Map<String, Collection<ClassificationScore>> binaryScores1 = classificationClient.classifyBinary(byteArrayOutputStream.toByteArray(), "44157109.pdf");
