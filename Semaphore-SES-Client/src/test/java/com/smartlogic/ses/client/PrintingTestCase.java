	...
	public void print(Object object) {
		...
		for (Method method: object.getClass().getMethods()) {
			if (method.getName().startsWith("get")) {
				if (method.getName().equals("getModifiers")) continue;
				if (method.getName().equals("getSuperclass")) continue;
				...
				if (method.getReturnType().getCanonicalName().equals("java.lang.String") 
					...
					try {
						System.out.println(object.getClass().getName() + ":\t\t" + method.getName() + ":\t\t" + method.invoke(object, new Object[] {} ));
					} catch (IllegalArgumentException e) {
						System.out.println("IllegalArgumentException: " + object.getClass().getName() + ":\t\t" + method.getName() + ":\t\t" + e.getMessage());
					} catch (IllegalAccessException e) {
						System.out.println("IllegalAccessException: " + object.getClass().getName() + ":\t\t" + method.getName() + ":\t\t" + e.getMessage());
					} catch (InvocationTargetException e) {
						System.out.println("InvocationTargetException: " + object.getClass().getName() + "\t\t:" + method.getName() + ":\t\t" + e.getMessage());
					}
					...
					try {
						...
						for (Object arrayObject: arrayList) {
							if (arrayObject.getClass().getCanonicalName().equals("java.lang.String")) {
								System.out.println(object.getClass().getName() + ":\t\t" + method.getName() + ":\t\t" + arrayObject);
							} else {
								print(arrayObject);
							}
						}
