...
public class TestConceptMapping extends SESServerMockTestCase {
  ...
  public void testConceptMappingBusiness() throws Exception {
    wireMockRule.stubFor(
        get(urlEqualTo("/ses?TBDB=IPSV&template=service.xml&service=conceptmap&query=business"))
            .willReturn(aResponse().withHeader("Content-Type", "text/xml").withBody(
                readFileToString("src/test/resources/ses/sesResponseConceptsBusiness.xml"))));
