...
public class OMStructure implements Serializable {
	...
	private <T> List<T> getList(Element element, String childTagName, Factory<T> factory) {
		TreeSet<T> children = new TreeSet<T>(factory);
	...
	private interface Factory<T> extends Comparator<T> { T make(Element elemen); }

	private class ClassTypeFactory implements Factory<ClassType> {
		@Override
		public ClassType make(Element element) { return new ClassType(element); }
	...
	private class FieldFactory implements Factory<Field> {
		@Override
		public Field make(Element element) { return new Field(element); }
	...
	private class AttributeFactory implements Factory<AttributeType> {
		@Override
		public AttributeType make(Element element) { return new AttributeType(element); }
	...
	private class NoteFactory implements Factory<NoteType> {
		@Override
		public NoteType make(Element element) { return new NoteType(element); }
	...
	private class ChoiceFactory implements Factory<ChoiceType> {
		@Override
		public ChoiceType make(Element element) { return new ChoiceType(element); }
	...
	private class RelationFactory implements Factory<RelationType> {
		@Override
		public RelationType make(Element element) { return new RelationType(element); }
	...
	private class UserFactory implements Factory<User> {
		@Override
		public User make(Element element) { return new User(element); }
