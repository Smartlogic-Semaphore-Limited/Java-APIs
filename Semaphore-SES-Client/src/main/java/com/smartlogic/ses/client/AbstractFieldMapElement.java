...
public abstract class AbstractFieldMapElement implements Serializable {
	...
	private static FieldComparator alphabeticalComparator = new FieldComparator(FieldComparator.SortField.ALPHABETICAL);
	private static FieldComparator frequencyComparator = new FieldComparator(FieldComparator.SortField.FREQUENCY);
