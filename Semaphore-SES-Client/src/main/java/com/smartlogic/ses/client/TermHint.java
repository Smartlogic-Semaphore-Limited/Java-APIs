...
public class TermHint implements Serializable {
  protected static final Logger logger = LoggerFactory.getLogger(TermHint.class);
  ...
  /*
   * @deprecated - Please use getFacets instead as that supports the idea that terms might have
   * multiple facets
   */
  @Deprecated
  ...
  /*
   * @deprecated - Please use setFacets instead as that supports the idea that terms might have
   * multiple facets
   */
  @Deprecated
  ...
  /*
   * @deprecated - Please use getValues instead as that supports the idea that PTs terms might have
   * multiple matching NPTs
   */
  @Deprecated
  @XmlTransient
  ...
  /*
   * @deprecated - Please use setValues instead as that supports the idea that PTs terms might have
   * multiple matching NPTs
   */
